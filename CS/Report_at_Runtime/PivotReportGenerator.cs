...
{
    public static XtraReport GenerateReport(PivotGridControl pivot,ReportGeneratorType kind,int columnWidth,bool repeatRowHeader)
    {
    ...
    private static void FillDatasetColumns(PivotGridControl pivot, DataTable dataTable1)
    {
        ...
        for (int i = 0; i < pivot.Cells.ColumnCount; i++)
        {
            ...
            {
                foreach (PivotGridField field in fieldsInColumnArea)
    ...
    private static List<PivotGridField> GetFieldsInArea(PivotGridControl pivot, PivotArea area)
    {
