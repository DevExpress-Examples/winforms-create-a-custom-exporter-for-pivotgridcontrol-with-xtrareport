...
Public NotInheritable Class PivotReportGenerator
	Private Sub New()
	End Sub
	Public Shared Function GenerateReport(ByVal pivot As PivotGridControl, ByVal kind As ReportGeneratorType, ByVal columnWidth As Integer, ByVal repeatRowHeader As Boolean) As XtraReport
			...
			Return rep
	End Function
	Public Shared Function FillDataset(ByVal pivot As PivotGridControl) As DataSet
	...
	Private Shared Sub FillDatasetExtracted(ByVal pivot As PivotGridControl, ByVal dataTable1 As DataTable)
		...
		Next i
	End Sub
	Private Shared Sub FillDatasetColumns(ByVal pivot As PivotGridControl, ByVal dataTable1 As DataTable)
		...
		For i As Integer = 0 To pivot.Cells.ColumnCount - 1
			...
			If pcea.ColumnValueType = PivotGridValueType.Value Then
				For Each field As PivotGridField In fieldsInColumnArea
		...
		Next i
	End Sub
	Private Shared Function GetFieldsInArea(ByVal pivot As PivotGridControl, ByVal area As PivotArea) As List(Of PivotGridField)
	...
	End Function
	 Private Shared Sub InitDetailsBasedonXRTableWithoutRepeatingRowHeader(ByVal rep As XtraReport, ByVal kind As ReportGeneratorType, ByVal columnWidth As Integer)
		...
		Select Case kind
			...
			Case Else
                colWidth = Convert.ToInt32((rep.PageWidth - (rep.Margins.Left + rep.Margins.Right)) / colCount)
